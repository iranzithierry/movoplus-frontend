              ...
              <div>
                ...
                <div className="flex flex-col items-start sm:flex-row sm:items-center sm:justify-between lg:flex-col lg:items-start">
                  <div className="mt-3 flex items-center">
                    ...
                    <div className="ml-4">
                      <p className={cn(plan.featured ? 'text-gray-700' : 'text-white', 'text-sm')}>
                        USD / mo
                      </p>
                      <p className={cn(plan.featured ? 'text-gray-500' : 'text-indigo-200', 'text-sm')}>
      ...
      <div className="mx-auto mt-16 max-w-2xl space-y-16 px-6">
        {plans.map((plan, planIndex) => (
          <div key={plan.title} className="border-t border-gray-200">
            ...
            >
              <h3
                className={cn(plan.featured ? 'text-indigo-600' : 'text-gray-900', 'text-sm font-bold')}
              >
                {plan.title}
              </h3>
        ...
        <div className="flex w-full items-stretch border-t border-gray-200">
          ...
          {plans.map((plan, index) => (
            <div
              key={plan.title}
              aria-hidden="true"
              className={cn(index === plans.length - 1 ? '' : 'pr-4', '-mt-px w-1/4 pl-4')}
            >
              <div
                className={cn(
                  plan.featured ? 'border-indigo-600' : 'border-transparent',
