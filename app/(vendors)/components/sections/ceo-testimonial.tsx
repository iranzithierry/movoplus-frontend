            ...
            <div className="mx-auto max-w-2xl lg:max-w-4xl p-2">
                ...
                <figure className="mt-10">
                    <blockquote className="text-center text-sm lg:text-xl font-semibold leading-6 lg:leading-8 text-gray-900 sm:text-2xl sm:leading-9">
                        <p>
                            “Our platform is dedicated to empowering vendors with the tools they need to succeed.
                            We&apos;re proud to offer an easy-to-use, secure marketplace that drives growth and delivers results.
                            Join us and experience a new level of e-commerce success.”
                        </p>
                    </blockquote>
