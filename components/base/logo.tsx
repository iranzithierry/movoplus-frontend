...
export default function Logo({ size = 'md', fillColor = 'black' }: LogoProps) {
  const sizeClasses = {
    xs: 'h-4',
    sm: 'h-6',
    md: 'h-8',
  ...
  return (
    <Link className="flex items-center justify-center" href="/marketplace">
      {/* <BuildingStorefrontIcon className={`${sizeClasses[size]} w-auto text-indigo-600`} /> */}
      <svg className={`${sizeClasses[size]} w-auto`} version="1.0" xmlns="http://www.w3.org/2000/svg" width="450.000000pt" height="202.000000pt" viewBox="0 0 450.000000 202.000000" preserveAspectRatio="xMidYMid meet">
        <metadata>Logo By Movo+</metadata>
        <g transform="translate(0.000000,202.000000) scale(0.100000,-0.100000)" fill={fillColor} stroke="none">
